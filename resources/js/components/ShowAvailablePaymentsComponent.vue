<template>
    ...
    <div class="bg-gray-200 mt-2 p-1 rounded-md dark:bg-gray-800">
        ...
        <div class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            ...
            <button @click="onContinueClicked" :disabled="!selectedPayment" :class="{'bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-600 hover:bg-gray-600 cursor-not-allowed':!selectedPayment}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Continue</button>
        </div>
    </div>
</template>
<script setup>
