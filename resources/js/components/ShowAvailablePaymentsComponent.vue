<template>
    ...
    <div class="bg-gray-200 mt-2 p-1 rounded-md dark:bg-gray-800">
        ...
        <div class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button  @click="onPaymentClicked(null,null)" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-purple-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Cancel</button>
            <button @click="onContinueClicked" :disabled="!selectedPayment" :class="{'bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-600 hover:bg-gray-600 cursor-not-allowed':!selectedPayment}" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Continue</button>
        </div>
    </div>
</template>
<script setup>
