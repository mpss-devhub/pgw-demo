            ...
            <div class="overflow-hidden shadow-sm sm:rounded-lg grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 lg:gap-4">
                @foreach ($products as $product)
                    <div
                        ...
                        <div>
                            <p class="px-4 py-2 mt-1 text-sm text-gray-600 dark:text-gray-400">{{ $product->description }}</p>

                            <div class="flex items-center flex-col lg:flex-row justify-between px-4 py-2 bg-gray-900">
